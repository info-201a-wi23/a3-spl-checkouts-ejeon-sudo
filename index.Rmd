...
As for the Fly Guy series' success in the recent years as a whole, it's no denying the fall in popularity they have had since 2017. There most popular year was in 2018 with a total of 12,680, and their most popular years fall in the 2017-2019 timeline. Additionally, by subtracting the number of 2017 with 2022 checkouts, I found that there was a difference of 5062, meaning there have been 5062 less checkouts since 2017. Nonetheless, Fly Guy is a treasured childhood memory for me and many others. I hope to see its checkout numbers rise in the future.
...
In this line graph, we can see the checkout trends for the top five most popular Fly Guy books in the series over recent years. We can see that the book that peaked the highest checkouts is “Fly Guy’s Ninja Christmas” in 2018 with 242 checkouts. However, it plummets down to the low 40’s, and the most consistently checked out book was “Flyswatter”. Nonetheless, the common trend that any of these popular books follow is that they drop in 2019 and has stayed relatively low since. 
