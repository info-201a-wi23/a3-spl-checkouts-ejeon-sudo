...
In this line graph, we can see the checkout trends for the top five most popular Fly Guy books in the series over recent years. In 2018, "Fly Guy's ninja Christmas" was the book that received the most checkouts in a single year with 242 checkouts. However, in 2020, it spirals down to only receiving 20 checkouts and have been rarely checked out ever since. In fact, 2019 was not a good year for most of the book sin the fly guy series as "Fly Guy and the Frankenfly", "Fly Guy meets Fly Girl", and "I spy Fly Guy" goes south on the graph due to its lack of checkouts. Only "Fly Guy vs. the flyswatter" escaped this decline and has been on a consistent rise since 2018. This consistency of checkouts when added up makes it the overall most checkout book in the series with `r most_popular_flyguy_checkouts` checkouts.
